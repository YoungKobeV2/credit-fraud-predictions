...
- Since we have to many variables , i decide to skip Plots for visually finding the useful / significant predictors . 
...
lasso_model %>%
  ...
  geom_col() +
  labs(title = "using step_normalize", y = "")
...
wf_set <- workflow_set(preproc = list(recipe_rf=recipe_rf,
                       ...
                       models = list(log_model=log_spec),cross = T,save_workflow=T)
...
The above code takes too long to run , best recipe rf_lasso
